...
class BasePage:
    ...
    def __init__(self, driver: WebDriver = None):
        if driver is None:
            ...
            desired_caps['appPackage'] = 'com.taobao.idlefish'  # app的名字：adb shell dumpsys package XXX
            desired_caps[
                'appActivity'] = 'com.taobao.fleamarket.home.activity.MainActivity'  # 同上↑  # .pages.splash.SplashActivity   pages.main.MainActivity
